...
module ApplicationHelper
  def marketing_company_path(company)
    "/marketing/companies/#{company.slug}"
  end

  def marketing_person_path(person)
    "/marketing/people/#{person.slug}"
  end

  def marketing_project_path(project)
    "/marketing/projects/#{project.slug}"
  end

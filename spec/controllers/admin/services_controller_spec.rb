...
describe Admin::ServicesController do
  ...
  describe "GET index" do
    it "assigns all admin_services as @admin_services" do
      ...
      assigns(:admin_services).should eq([service])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested admin_service as @admin_service" do
      ...
      assigns(:admin_service).should eq(service)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new admin_service as @admin_service" do
      ...
      assigns(:admin_service).should be_a_new(Admin::Service)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created admin_service as @admin_service" do
        post :create, {:admin_service => valid_attributes}, valid_session
        assigns(:admin_service).should be_a(Admin::Service)
        assigns(:admin_service).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_service as @admin_service" do
        ...
        post :create, {:admin_service => {}}, valid_session
        assigns(:admin_service).should be_a_new(Admin::Service)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin_service" do
        ...
        Admin::Service.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => service.to_param, :admin_service => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_service as @admin_service" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Admin::Service.any_instance.stub(:save).and_return(false)
        put :update, {:id => service.to_param, :admin_service => {}}, valid_session
        assigns(:admin_service).should eq(service)
      end

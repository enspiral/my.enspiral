...
module XeroImport
  ...
  def insert_single_invoice xero_invoice, c_id=nil
    ...
    return nil if new_invoice.invalid? && new_invoice.errors[:xero_id] && (new_invoice.errors[:xero_id].grep(/already been taken/).any? || new_invoice.errors[:xero_reference].grep(/already been taken/).any?)
